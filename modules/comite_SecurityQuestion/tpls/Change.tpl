...
<form action="index.php" method="post" name="ChangeSecurityQuestionForm" id="ChangeSecurityQuestionForm" onsubmit="return document.getElementById('cant_login').value == ''">
...
<td align="center">
		...
		<tr>
			<td scope="row">{$MOD.LBL_SECURITY_QUESTION}:</td>
			<td width="30%">
                            <select name="security_question">
                                {foreach from=$questions key=value item=question}
		...
		<tr>
			<td scope="row">{$MOD.LBL_SECURITY_QUESTION_ANSWER}:</td>
			<td width="30%"><input type="text" size="26" tabindex="2" id="security_question_answer" name="security_question_answer" value="" /> 
                            <div id="comfirm_pwd_match" class="error" style="display: none;">mis-match</div></td>
		</tr>
		<tr>
			<td>{$CAPTCHA}</td>
		</tr>
