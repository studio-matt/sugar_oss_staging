...
class comite_LoginAuditViewResetSubmit extends SugarView
{
  ...
  public function display()
  {
        ...
        '$ip_address','$typed_name','$current_user->is_admin','Reset')";

        $result = $db->query($query,false);

        $_SESSION['flash'] = "User's access has been reset";
        
        header('Location: index.php?module=comite_LoginAudit&action=Reset');
        exit;
  }
}
