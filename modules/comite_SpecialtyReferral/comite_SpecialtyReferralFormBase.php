...
class comite_SpecialtyReferralFormBase extends FormBase {
...
function handleSave($prefix,$redirect=true, $useRequired=false) {
	...
	$focus = new comite_SpecialtyReferral();
        $focus->name = $_REQUEST['name'];
        $focus->specialty_type = $_REQUEST['specialty_type'];
        $focus->address = $_REQUEST['address'];
        $focus->phone = $_REQUEST['phone'];
        $focus->save();
