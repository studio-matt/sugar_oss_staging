    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'restrict_to_ips_c',
            'studio' => 'visible',
            'label' => 'LBL_RESTRICT_TO_IPS',
          ),
        ),
        4 => 
        array (
        ...
        array (
          0 => 
          array (
            'name' => 'security_question_c',
            'studio' => 'visible',
            'label' => 'LBL_SECURITY_QUESTION',
          ),
          1 => 
          array (
            'name' => 'security_question_answer_c',
            'label' => 'LBL_SECURITY_QUESTION_ANSWER',
          ),
        ),
      ),
