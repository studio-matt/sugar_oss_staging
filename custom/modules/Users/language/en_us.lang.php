...
<br><br>Load the metric file generated in step 2 and your font file below.',
  ...
  'LBL_WIZARD_WELCOME_TITLE' => 'Welcome to Dr. Comite MD!',
...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
  ...
  'LBL_WELCOME' => 'Welcome',
  'LBL_LOGO' => 'Logo',
  'LBL_TOO_MANY_FAILED_ATTEMPTS' => 'Your account has been locked for 30 minutes due to too many failed attempts',
  'LBL_RESTRICTED_IP' => 'Your account is restricted from using this IP Address',
  'LBL_RESTRICT_TO_IPS' => 'Restrict To IPs',
  'LBL_SECURITY_QUESTION_ANSWER' => 'Security Question Answer',
  'LBL_SECURITY_QUESTION_ANSWER_INCORRECT' => 'Your Security Question Answer is incorrect',
  'LBL_SECURITY_QUESTION' => 'Security Question',
  'LBL_REQUIRE_SECURE_PASSWORD' => 'Your password is not secure enough.<br /> Please follow the instructions below.',
);