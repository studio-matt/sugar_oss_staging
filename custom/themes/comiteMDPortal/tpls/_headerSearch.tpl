...
<div id="search">
    <form name='UnifiedSearch' action='index.php' onsubmit='return SUGAR.unifiedSearchAdvanced.checkUsaAdvanced()'>
        ...
        {sugar_getimage name="search" ext=".png" alt=$APP.LBL_SEARCH other_attributes='border="0" id="unified_search_advanced_img" '}&nbsp;
        {$APP.LBL_SEARCH}&nbsp;
        <input type="text" name="query_string" id="query_string" value="{$SEARCH}">
        <!--
