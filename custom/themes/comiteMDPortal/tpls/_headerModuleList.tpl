...
<div id="subModuleList" class="clearfix">
    {assign var="groupSelected" value=false}
...
<div id="moduleList">
<ul>
    <li>{sugar_link module=comite_Portal action=patient_demographics label=HLA}
        <ul class="cssmenu">
            <li>{sugar_link module=comite_Portal action=patient_demographics label="Patient Demographics"}</li>
        </ul>
    </li>
