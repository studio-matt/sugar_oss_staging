...
*}
<div id="subpanel_title_comite_angryreactioninstance_comite_lifestyle" onmouseover="this.style.cursor = 'move';" style="cursor: move;">
    ...
    <tbody>
      <tr>
        <td nowrap="">
          <h3>
            <span>
              <a name="comite_angryreactioninstance_comite_lifestyle"> </a>
              <span id="show_link_subpanel_comite_lifestyle" style="display: none">
                <a class="utilsLink" onclick="current_child_field = 'subpanel_comite_lifestyle';showSubPanel_static('comite_lifestyle');document.getElementById('show_link_subpanel_comite_lifestyle').style.display='none';document.getElementById('hide_link_subpanel_comite_lifestyle').style.display='';return false;" href="#">
                  <img border="0 align=" alt="Show" absmiddle="" src="custom/themes/comiteMD/images/advanced_search.gif?v=aDkS__ez8-bGzEoHYCGEyA">
                </a>
              </span>
              <span id="hide_link_subpanel_comite_lifestyle" style="display: inline">
                <a class="utilsLink" onclick="hideSubPanel('comite_lifestyle');document.getElementById('hide_link_subpanel_comite_lifestyle').style.display='none';document.getElementById('show_link_subpanel_comite_lifestyle').style.display='';return false;" href="#">
                  <img border="0" align="absmiddle" alt="Hide" src="custom/themes/comiteMD/images/basic_search.gif?v=aDkS__ez8-bGzEoHYCGEyA">
                </a>
              </span>&nbsp;{$SECTION_TITLE}
            </span>
          </h3>
...
<div id="subpanel_comite_lifestyle" style="" cookie_name="subpanel_comite_lifestyle_v">
{{include file="custom/include/generic/tpls/SubPanelHeader.tpl"}}
