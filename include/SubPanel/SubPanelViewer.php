...
if(!in_array($subpanel, array('comite_medsuppinst_comite_personalhealthhistory'))) {
	...
	$subpanel_object = new SubPanelMedTable($module, $record, $subpanel,null, $layout_def_key);
}
