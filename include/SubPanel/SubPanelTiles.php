...
EOQ;
            ...
            if($div_display != 'none'){
            	...
            	ob_start();
            	if(!in_array($tab, array('comite_medsuppinst_comite_personalhealthhistory'))) {
                	...
                	include_once('custom/include/SubPanel/SubPanelMedTable.php');
                	$subpanel_object = new SubPanelMedTable($this->module, $_REQUEST['record'], $tab,$thisPanel,$layout_def_key);
                }
