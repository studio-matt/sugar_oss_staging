...
{
    if(jQuery('form[name="DetailView"]').length < 2) {
        /* Original Code */
        ...
        if(typeof(detailViewForm.elements['subpanel_parent_module']) != 'undefined' &&
                ...
                return detailViewForm.elements['subpanel_parent_module'].value;
        }
        return detailViewForm.elements['module'].value;
    }
}
...
t.href=url;}
function sub_p_rem(sp,lf,li,rp){console.log(sp); return_url="index.php?module="+get_module_name(sp)+"&action=SubPanelViewer&subpanel="+sp+"&record="+get_record_id(sp)+"&sugar_body_only=1&inline=1";remove_url="index.php?module="+get_module_name(sp)
+"&action=DeleteRelationship"
+"&record="+get_record_id(sp)
+"&linked_field="+lf
+"&linked_id="+li
...
function get_record_id(/*child_field*/)
{
    if(jQuery('form[name="DetailView"]').length < 2) {
        /* Original Code */
...
function get_layout_def_key(/*child_field*/)
{
    if(jQuery('form[name="DetailView"]').length < 2) {
        /* Original Code */
...
{var module=get_module_name(child_field);var id=get_record_id(child_field);if(typeof(layout_def_key)=='undefined'||layout_def_key==null){layout_def_key=get_layout_def_key(child_field);}
