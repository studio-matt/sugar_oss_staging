...
{else}
	...
	{{if empty($vardef.autocomplete_ajax)}}
		...
		(function (){
			...
			YUI({base:'include/javascript/yui3/build/'}).use('datasource', 'datasource-jsonschema',function (Y) {
	...
	{literal}
		YUI({base:'include/javascript/yui3/build/'}).use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
	{/literal}
